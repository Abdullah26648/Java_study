      ...
      /* str bir String'dir.
        ...
        if (str.equals("Orange")) {
            if (str.length() == 6) {
                ...
                System.out.println("String doesn't contain orange and length is less then 6");
            }
        } else if (str.equals("Apple")) {
            if (str.length() == 5) {
                System.out.println("Apple has five letters");
            } else if (str.length() > 5) {
                System.out.println("String contain apple and length is more then 10");
            } else {
                System.out.println("String doesn't contain apple and length is less then 5");
            }
        } else if (str.length() > 10) {
            System.out.println("String contain --> " + str + " <-- and length is more then 10");
        } else {
            System.out.println("String contain --> " + str + " <-- and length is less then 10");
        }
    }
}
